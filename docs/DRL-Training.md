...
```
/catkin_ws/src/arena-fsm-ego-planner/arena_navigation/arena_local_planner/learning_based/arena_local_planner_drl/scripts/training/train_agent.py
```
...
```
**Notes**: 
- Make sure that drl mode is activated in *Parameter.yaml* (*../arena-fsm-ego-planner/arena_bringup/launch*)
