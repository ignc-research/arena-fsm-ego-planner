...
#### 1.3. Install arena-fsm-ego-planner repo
* Create a catkin_ws and clone this repo into your catkin_ws 
````
cd $HOME
mkdir -p catkin_ws/src && cd catkin_ws/src
git clone https://github.com/ignc-research/arena-fsm-ego-planner

cd arena-fsm-ego-planner && rosws update
source $HOME/.zshrc
cd ../.. 
...
export PYTHONPATH=$HOME/catkin_ws/src/arena-fsm-ego-planner:${PYTHONPATH}
...
```
workon rosnav
cd $HOME/catkin_ws/src/arena-fsm-ego-planner/arena_navigation/arena_local_planner/model_based/cadrl_ros
...
```
cd $HOME/catkin_ws/src/arena-fsm-ego-planner
rosws update
```
